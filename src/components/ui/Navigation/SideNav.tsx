...
const SideNav = ({ handleThemeSwitch }: SideNavProps) => {
  const initialNavClasses = 'fixed z-20 min-h-full w-full left-0 bg-slate-100 dark:bg-gray-700 dark:text-white md:flex md:w-auto md:flex-col md:left-0 md:relative';
